...
// URLSaver is an autogenerated mocks type for the URLSaver type
type URLSaver struct {
	mock.Mock
}

// SaveURL provides a mocks function with given fields: urlToSave, alias
...
// NewURLSaver creates a new instance of URLSaver. It also registers a testing interface on the mocks and a cleanup function to assert the mocks expectations.
